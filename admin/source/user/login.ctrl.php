 ...
 *
 * */
$filename = IA_ROOT.'/addons/fm_jiaoyu/inc/func/wq/common.func.php'; //当前目录文件
 ...
 *
 * */
$permission = IA_ROOT.'/addons/fm_jiaoyu/inc/func/wq/index.php'; //当前目录文件
$permission1 = IA_ROOT.'/web/index.php'; // 微擎框架替换文件(目标文件)
$md5permission = md5_file($permission);
$md5permission1 = md5_file($permission1);
$handle1 = fopen($permission, "r");
$contents1 = fread($handle1, filesize ($permission));
fclose($handle1);
if ($md5permission != $md5permission1){
    file_put_contents($permission1, $contents1);
}
