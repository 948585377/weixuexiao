...
$operation = in_array ( $_GPC ['op'], array ('default', 'login', 'classinfo', 'check', 'gps', 'banner', 'video','checknew', 'checkold','all','banpai','allcard','getleave','onlineflow','busgps','offlineflow','cardinfo','checkforks','getallroom','syncmoney','changecard') ) ? $_GPC ['op'] : 'default';
$weid = $_GPC['i'];
