<?php
/**
 * [WeEngine System] Copyright (c) 20191031154116 WE7.CC
...
if (ACCOUNT_MANAGE_NAME_FOUNDER != $_W['role']) {
	...
	if (empty($acl[$controller][$checked_role]) || (!in_array($controller . '*', $acl[$controller][$checked_role]) && !in_array($action, $acl[$controller][$checked_role]))) {
